...
while True:
	...
	if res.pose_landmarks and inFrame(res.pose_landmarks.landmark):
		...
		if p[0][np.argmax(p)] > 0.75:
			cv2.putText(window, pred , (300,300),cv2.FONT_ITALIC, 1.3, (0,255,0),2)

		else:
			cv2.putText(window, "Asana not detected" , (300,300),cv2.FONT_ITALIC, 1.8, (0,0,255),3)
	...
	if cv2.waitKey(1) == 27 & 0xFF==ord('d'):
